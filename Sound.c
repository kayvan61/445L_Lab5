...
static const Note songLeft[NUM_NOTES] = {
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2},
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, 
	{1, 0, 1}, {1, 0, 1}, 
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2},
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2},
	{1, 0, 1}, {1, 0, 1}, 
	...
	{1, 0, 1}, {1, 0, 1}, 
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, 
	{1, B0, 2}, {1, B0, 2}, {1, B0, 2}, {1, B0, 2}, 
	{1, 0, 1}, {1, 0, 1}, 
	{1, B0, 2}, 
	{1, 0, 1}, {1, 0, 1}, 
	{1, B1, 12}, {1, E0, 12}, {1, B0, 12}, {1, A0, 12}, {1, B1, 12},
	{1, E0, 12}, {1, B0, 12}, {1, C_1, 12},
	//d---dCd---Cde-d-
	{1, D_1, 4}, {1, D_1, 1}, {1, C_1, 1}, {1, D_1, 4},
	{1, C_1, 1}, {1, D_1, 1}, {1, E_1, 2}, {1, D_1, 2}
};
